...
- 详细 CSV：`runtime-benchmark-20260816-220741.csv`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 600 | 2.18 | 34.68 | 1.94 | 31.82 | 10699.66 | 12629 | 37578.82 | 49326 | 109.94 | 1919.06 | 1 | 14 | 14 | 0 |
| Data-Oriented CPU ROAM | 600 | 3.27 | 111.38 | 2.62 | 22.06 | 10699.66 | 12629 | 37578.82 | 49326 | 174.36 | 6925.59 | 8 | 14 | 14 | 0 |
| GPU ROAM-like | 600 | 5.32 | 35.92 | 4.89 | 28.31 | 10699.66 | 12629 | 37578.82 | 49326 | 127.40 | 2222.67 | 8 | 14 | 14 | 0 |
...
| --- | ---: | ---: | ---: | ---: | --- |
| Prepare / 帧状态 | 0.0945 | 0.1260 | 0.2296 | N/A | CPU 准备持久拓扑和 snapshot 输入 |
| Merge 候选评分 | 0.4553 | 0.1492 | 0.2081 | 0.0052 | Shader 为诊断重新扫描已 split 的父节点；GPU 不提交这些候选 |
| Merge 拓扑提交 / 向上级联 | 0.0282 | 0.0618 | 0.0737 | N/A | 持久 merge、邻接修复和级联回收由 Classic/DOD CPU 路径执行；GPU shader 未提交 merge |
| Split 前 active leaf 收集 | 0.0000 | 0.0000 | 0.0000 | 0.0046 | DOD CPU 直接以持久 Q_s 表示 active leaf 与预算计数，本列为 0；GPU 在评分前仍单独压缩 snapshot |
| 视点相关 leaf error / 视锥测试 | 0.0000 | 0.0000 | 0.0000 | 0.0046 | Classic 与 DOD 都把评分计入持久 Q_s 优先级刷新，本列为 0；GPU 基于 snapshot 单独评分 |
| Split 扫描/标记 | 0.5035 | 0.2466 | 0.5138 | 0.0043 | DOD CPU 数值包含持久 Q_s 的并行 SSE/视锥优先级刷新、原地建堆和提交快照生成；GPU append 顺序不是误差优先级顺序 |
| Split 拓扑 / 裂缝约束提交 | 0.0719 | 0.0932 | 0.1078 | 0.0030 | GPU 只提交一轮受预算约束的细分，并只处理直接 base-neighbor diamond pair；没有递归 forced-split 链 |
...
| Mesh emit / draw argument 生成 | 0.0465 | 0.8743 | 0.0000 | 0.0102 | Classic 只重写拓扑变化影响的稳定槽位；DOD 仍完整 emit；GPU 输出非共享顶点、索引和 indirect draw argument |
| Finalize / 发布 packet | 0.7091 | 0.7757 | 1.0583 | N/A | CPU 发布统计和 renderer 资源契约 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 1.9092 | 0.0945 | 0.4553 | 0.0282 | 0.0000 | 0.0000 | 0.5035 | 0.0719 | 0.0000 | 0.0465 | 0.7091 | 0.0280 |
| Data-Oriented CPU ROAM | 2.3272 | 0.1260 | 0.1492 | 0.0618 | 0.0000 | 0.0000 | 0.2466 | 0.0932 | 0.0000 | 0.8743 | 0.7757 | 0.2435 |
| GPU ROAM-like | 2.1917 | 0.2296 | 0.2081 | 0.0737 | 0.0000 | 0.0000 | 0.5138 | 0.1078 | 0.0000 | 0.0000 | 1.0583 | 0.5850 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic Split | 0 | 0 | 0 | 0 | 0 | 0.0719 | 0.0719 | 0.0719 |
| DoD Split | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0930 | 0.0930 | 0.0932 |
| Merge | 0.0056 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0545 | 0.0601 | 0.0618 |
...
| --- | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 0.5754 | 0.4835 | 0.0465 | 0.0000 |
| Data-Oriented CPU ROAM | 0.3399 | 0.2111 | 0.8743 | 0.0000 |
| GPU ROAM-like | 0.6217 | 0.2818 | 0.0000 | 0.0000 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| GPU ROAM-like | 0.0046 | 0.0046 | 0.0043 | 0.0052 | 0.0030 | 0.0028 | 0.0038 | 0.0102 | 0.0385 | 0.3847 |
...
| GPU ROAM-like | 1.23 | 0.08 | 0.09 | 0.00 | 0.46 | 0.00 | 0.00 | 0.00 | 5524564 | 96 |
