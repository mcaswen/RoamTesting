...
- 详细 CSV：`runtime-benchmark-20260828-194836.csv`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 600 | 4.62 | 8.40 | 4.40 | 7.98 | 18758.02 | 19608 | 117377.00 | 205068 | 95.62 | 504.47 | 1 | 20 | 19 | 0 |
| Data-Oriented CPU ROAM | 600 | 2.35 | 7.66 | 2.14 | 7.45 | 18758.02 | 19608 | 117377.00 | 205068 | 305.20 | 8295.18 | 8 | 20 | 19 | 0 |
| CBT 2024 | 600 | 0.28 | 3.59 | 0.03 | 0.14 | 18732.14 | 20028 | 18732.14 | 20028 | 0.00 | 0.00 | 0 | 20 | 20 | 0 |
...
- dropped/错代样本：0
- 最大诊断样本年龄：2 帧
- 平均 GPU 阶段合计：0.0774 ms
- 最大 GPU 阶段合计：0.3009 ms
...
| --- | ---: | ---: | --- |
| Prepare / 帧状态 | 0.1465 | 0.1457 | 准备持久拓扑和逐帧输入 |
| Merge 候选评分 | 0.5930 | 0.1338 | 刷新持久 Q_m 的优先级 |
| Merge 拓扑提交 / 向上级联 | 0.0921 | 0.1227 | 提交 diamond merge、邻接修复和级联回收 |
| Split 前 active leaf 收集 | 0.0000 | 0.0000 | 两者均直接复用持久活动叶表示 |
| 视点相关 leaf error / 视锥测试 | 0.0000 | 0.0000 | 计入持久 Q_s 优先级刷新，因此独立字段为 0 |
| Split 扫描/标记 | 1.8650 | 0.3653 | 刷新 Q_s、建堆并生成提交候选 |
| Split 拓扑 / 裂缝约束提交 | 0.2081 | 0.2444 | 按同一预算与 forced-split 约束提交 |
| 细分后 active leaf 收集 / 输出视图 | 0.0000 | 0.0000 | Classic 复用 dense slot owners，DOD 复用 ActiveLeafNodes |
| Mesh emit / draw argument 生成 | 0.1921 | 0.1563 | 两者均只重写 dirty slot；DOD 可将较大批次分段给 worker |
| Finalize / 发布 packet | 1.1338 | 0.8492 | 汇总统计、更新跨帧状态并发布 renderer packet |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 4.2308 | 0.1465 | 0.5930 | 0.0921 | 0.0000 | 0.0000 | 1.8650 | 0.2081 | 0.0000 | 0.1921 | 1.1338 | 0.1577 |
| Data-Oriented CPU ROAM | 2.0175 | 0.1457 | 0.1338 | 0.1227 | 0.0000 | 0.0000 | 0.3653 | 0.2444 | 0.0000 | 0.1563 | 0.8492 | 0.1212 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic Split | 0 | 0 | 0 | 0 | 0 | 0.2081 | 0.2081 | 0.2081 |
| DoD Split | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.2442 | 0.2442 | 0.2444 |
| Merge | 0.0060 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.1157 | 0.1216 | 0.1227 |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 0 | 1340.3733 | 17417.6467 | 930.2383 | 3290448 |
...
| --- | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 2.0731 | 0.6850 | 0.1921 | 0.0000 |
| Data-Oriented CPU ROAM | 0.6097 | 0.2565 | 0.1563 | 0.0000 |
| CBT 2024 | 0.0265 | 0.0131 | 0.0051 | 0.0015 |

## 渲染与上传

| Algorithm | Frame fence wait | Render | Max render | Max upload B | Max readback B |
| --- | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 0.00 | 0.02 | 0.28 | 3290448 | 0 |
| Data-Oriented CPU ROAM | 0.00 | 0.02 | 0.13 | 516936 | 0 |
| CBT 2024 | 0.09 | 0.09 | 0.40 | 0 | 428 |
