...
- 详细 CSV：`runtime-benchmark-20260828-194141.csv`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 64 | 186.39 | 201.65 | 187.04 | 201.00 | 200000.00 | 200000 | 1125600.03 | 1614326 | 100.56 | 106.24 | 1 | 20 | 20 | 0 |
| Data-Oriented CPU ROAM | 64 | 102.22 | 137.25 | 102.50 | 136.58 | 199999.55 | 200000 | 1125597.62 | 1614322 | 169.45 | 437.29 | 8 | 20 | 20 | 0 |
| CBT 2024 | 64 | 4.56 | 29.26 | 0.06 | 0.12 | 296197.22 | 314328 | 296197.22 | 314328 | 0.00 | 0.00 | 0 | 20 | 20 | 0 |
...
- dropped/错代样本：0
- 最大诊断样本年龄：2 帧
- 平均 GPU 阶段合计：2.5108 ms
- 最大 GPU 阶段合计：5.8332 ms
...
| Split | 0.0406 |
| Allocate | 0.0630 |
| Neighbor copy | 0.2676 |
| Bisect | 0.0238 |
| PropagateBisect | 0.0342 |
| PrepareSimplify | 0.0155 |
| Simplify | 0.0247 |
| PropagateSimplify | 0.0204 |
| ReducePre | 0.0139 |
| ReduceFirst | 0.0120 |
| ReduceSecond | 0.0073 |
| Indexation / indirect | 0.1504 |
| Render vertex evaluation | 0.0581 |
| Validation | 0.0015 |
| Terrain render | 1.2715 |
...
| --- | ---: | ---: | --- |
| Prepare / 帧状态 | 5.7196 | 6.6299 | 准备持久拓扑和逐帧输入 |
| Merge 候选评分 | 13.5653 | 2.3861 | 刷新持久 Q_m 的优先级 |
| Merge 拓扑提交 / 向上级联 | 16.2598 | 19.3697 | 提交 diamond merge、邻接修复和级联回收 |
| Split 前 active leaf 收集 | 0.0000 | 0.0000 | 两者均直接复用持久活动叶表示 |
| 视点相关 leaf error / 视锥测试 | 0.0000 | 0.0000 | 计入持久 Q_s 优先级刷新，因此独立字段为 0 |
| Split 扫描/标记 | 40.6977 | 5.3296 | 刷新 Q_s、建堆并生成提交候选 |
| Split 拓扑 / 裂缝约束提交 | 27.0537 | 26.3979 | 按同一预算与 forced-split 约束提交 |
| 细分后 active leaf 收集 / 输出视图 | 0.0000 | 0.0000 | Classic 复用 dense slot owners，DOD 复用 ActiveLeafNodes |
| Mesh emit / draw argument 生成 | 26.4027 | 9.6962 | 两者均只重写 dirty slot；DOD 可将较大批次分段给 worker |
| Finalize / 发布 packet | 52.7824 | 26.5372 | 汇总统计、更新跨帧状态并发布 renderer packet |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 182.4825 | 5.7196 | 13.5653 | 16.2598 | 0.0000 | 0.0000 | 40.6977 | 27.0537 | 0.0000 | 26.4027 | 52.7824 | 4.3573 |
| Data-Oriented CPU ROAM | 96.3470 | 6.6299 | 2.3861 | 19.3697 | 0.0000 | 0.0000 | 5.3296 | 26.3979 | 0.0000 | 9.6962 | 26.5372 | 5.8885 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic Split | 0 | 0 | 0 | 0 | 0 | 27.0537 | 27.0537 | 27.0537 |
| DoD Split | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 26.3974 | 26.3974 | 26.3979 |
| Merge | 0.1673 | 0.8731 | 0.2967 | 0.0098 | 3.5683 | 14.4436 | 19.3588 | 19.3697 |
...
| --- | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 67.7514 | 29.8251 | 26.4027 | 0.0000 |
| Data-Oriented CPU ROAM | 43.7505 | 21.7558 | 9.6962 | 0.0000 |
| CBT 2024 | 0.4291 | 0.0606 | 0.0582 | 0.0015 |

## 渲染与上传

| Algorithm | Frame fence wait | Render | Max render | Max upload B | Max readback B |
| --- | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 0.00 | 0.91 | 1.14 | 20126568 | 0 |
| Data-Oriented CPU ROAM | 0.00 | 0.95 | 1.15 | 20126064 | 0 |
| CBT 2024 | 4.19 | 2.68 | 5.96 | 0 | 428 |
