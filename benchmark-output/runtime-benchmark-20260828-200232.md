...
- 详细 CSV：`runtime-benchmark-20260828-200232.csv`
...
- Benchmark 标签：five-round-1280x720-default-r04
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 600 | 4.36 | 7.32 | 4.18 | 7.06 | 18758.02 | 19608 | 117377.00 | 205068 | 103.06 | 478.99 | 1 | 20 | 19 | 0 |
| Data-Oriented CPU ROAM | 600 | 3.70 | 9.47 | 3.49 | 9.18 | 18758.02 | 19608 | 117377.00 | 205068 | 230.89 | 4236.86 | 8 | 20 | 19 | 0 |
| CBT 2024 | 600 | 0.33 | 0.78 | 0.04 | 0.14 | 18732.14 | 20028 | 18732.14 | 20028 | 0.00 | 0.00 | 0 | 20 | 20 | 0 |
...
- dropped/错代样本：0
- 最大诊断样本年龄：2 帧
- 平均 GPU 阶段合计：0.0782 ms
- 最大 GPU 阶段合计：0.2840 ms
...
| --- | ---: | ---: | --- |
| Prepare / 帧状态 | 0.1546 | 0.2295 | 准备持久拓扑和逐帧输入 |
| Merge 候选评分 | 0.5838 | 0.2693 | 刷新持久 Q_m 的优先级 |
| Merge 拓扑提交 / 向上级联 | 0.0876 | 0.1757 | 提交 diamond merge、邻接修复和级联回收 |
| Split 前 active leaf 收集 | 0.0000 | 0.0000 | 两者均直接复用持久活动叶表示 |
| 视点相关 leaf error / 视锥测试 | 0.0000 | 0.0000 | 计入持久 Q_s 优先级刷新，因此独立字段为 0 |
| Split 扫描/标记 | 1.8153 | 0.6611 | 刷新 Q_s、建堆并生成提交候选 |
| Split 拓扑 / 裂缝约束提交 | 0.1984 | 0.3143 | 按同一预算与 forced-split 约束提交 |
| 细分后 active leaf 收集 / 输出视图 | 0.0000 | 0.0000 | Classic 复用 dense slot owners，DOD 复用 ActiveLeafNodes |
| Mesh emit / draw argument 生成 | 0.1750 | 0.2538 | 两者均只重写 dirty slot；DOD 可将较大批次分段给 worker |
| Finalize / 发布 packet | 1.0018 | 1.4371 | 汇总统计、更新跨帧状态并发布 renderer packet |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 4.0167 | 0.1546 | 0.5838 | 0.0876 | 0.0000 | 0.0000 | 1.8153 | 0.1984 | 0.0000 | 0.1750 | 1.0018 | 0.1595 |
| Data-Oriented CPU ROAM | 3.3408 | 0.2295 | 0.2693 | 0.1757 | 0.0000 | 0.0000 | 0.6611 | 0.3143 | 0.0000 | 0.2538 | 1.4371 | 0.1400 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic Split | 0 | 0 | 0 | 0 | 0 | 0.1984 | 0.1984 | 0.1984 |
| DoD Split | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.3140 | 0.3140 | 0.3143 |
| Merge | 0.0080 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.1653 | 0.1732 | 0.1757 |
...
| --- | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 2.0137 | 0.6714 | 0.1750 | 0.0000 |
| Data-Oriented CPU ROAM | 0.9753 | 0.4450 | 0.2538 | 0.0000 |
| CBT 2024 | 0.0264 | 0.0138 | 0.0052 | 0.0015 |
...
| Data-Oriented CPU ROAM | 0.00 | 0.01 | 0.23 | 516936 | 0 |
| CBT 2024 | 0.11 | 0.09 | 0.30 | 0 | 428 |
