...
- 详细 CSV：`runtime-benchmark-20260828-200122.csv`
...
- Benchmark 标签：five-round-1280x720-extreme-r02
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 64 | 201.99 | 229.50 | 203.07 | 229.09 | 200000.00 | 200000 | 1127313.44 | 1618212 | 99.93 | 107.81 | 1 | 20 | 20 | 0 |
| Data-Oriented CPU ROAM | 64 | 115.74 | 159.51 | 116.56 | 159.05 | 199999.44 | 200000 | 1127303.84 | 1618198 | 179.60 | 380.70 | 8 | 20 | 20 | 0 |
| CBT 2024 | 64 | 0.45 | 1.00 | 0.07 | 0.17 | 201811.17 | 216723 | 201811.17 | 216723 | 0.00 | 0.00 | 0 | 20 | 20 | 0 |
...
- dropped/错代样本：0
- 最大诊断样本年龄：2 帧
- 平均 GPU 阶段合计：0.1758 ms
- 最大 GPU 阶段合计：0.4057 ms
...
| --- | ---: | ---: | --- |
| Prepare / 帧状态 | 3.5074 | 4.1737 | 准备持久拓扑和逐帧输入 |
| Merge 候选评分 | 15.2522 | 2.8734 | 刷新持久 Q_m 的优先级 |
| Merge 拓扑提交 / 向上级联 | 18.9810 | 23.1406 | 提交 diamond merge、邻接修复和级联回收 |
| Split 前 active leaf 收集 | 0.0000 | 0.0000 | 两者均直接复用持久活动叶表示 |
| 视点相关 leaf error / 视锥测试 | 0.0000 | 0.0000 | 计入持久 Q_s 优先级刷新，因此独立字段为 0 |
| Split 扫描/标记 | 48.4289 | 6.8329 | 刷新 Q_s、建堆并生成提交候选 |
| Split 拓扑 / 裂缝约束提交 | 33.2103 | 32.7437 | 按同一预算与 forced-split 约束提交 |
| 细分后 active leaf 收集 / 输出视图 | 0.0000 | 0.0000 | Classic 复用 dense slot owners，DOD 复用 ActiveLeafNodes |
| Mesh emit / draw argument 生成 | 26.8235 | 11.7550 | 两者均只重写 dirty slot；DOD 可将较大批次分段给 worker |
| Finalize / 发布 packet | 51.4258 | 27.6152 | 汇总统计、更新跨帧状态并发布 renderer packet |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 197.6299 | 3.5074 | 15.2522 | 18.9810 | 0.0000 | 0.0000 | 48.4289 | 33.2103 | 0.0000 | 26.8235 | 51.4258 | 5.1952 |
| Data-Oriented CPU ROAM | 109.1348 | 4.1737 | 2.8734 | 23.1406 | 0.0000 | 0.0000 | 6.8329 | 32.7437 | 0.0000 | 11.7550 | 27.6152 | 7.1106 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic Split | 0 | 0 | 0 | 0 | 0 | 33.2103 | 33.2103 | 33.2103 |
| DoD Split | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 32.7435 | 32.7435 | 32.7437 |
| Merge | 0.1687 | 1.0585 | 0.4542 | 0.0119 | 4.3841 | 17.0492 | 23.1267 | 23.1406 |
...
| --- | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 81.6392 | 34.2332 | 26.8235 | 0.0000 |
| Data-Oriented CPU ROAM | 53.3547 | 26.0140 | 11.7550 | 0.0000 |
| CBT 2024 | 0.0480 | 0.0153 | 0.0199 | 0.0015 |
