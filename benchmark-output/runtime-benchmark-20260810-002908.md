...
- 相机路径：从地形边缘中点移动到地形中心
- 每种算法的采样时长：10 秒
- 详细 CSV：`runtime-benchmark-20260810-002908.csv`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 5615 | 1.78 | 29.30 | 1.61 | 26.82 | 10568.32 | 12629 | 38313.93 | 49326 | 109.11 | 2813.54 | 1 | 14 | 14 | 0 |
| Data-Oriented CPU ROAM | 3052 | 3.29 | 96.81 | 2.88 | 30.32 | 10508.03 | 12629 | 38730.52 | 49326 | 281.73 | 6764.07 | 8 | 14 | 14 | 0 |
| GPU ROAM-like | 2435 | 4.12 | 36.02 | 3.85 | 35.69 | 10633.17 | 12629 | 37900.32 | 49326 | 146.01 | 4834.65 | 8 | 14 | 14 | 0 |
...
| --- | ---: | ---: | ---: | ---: | --- |
| Prepare / 帧状态 | 0.1168 | 0.1857 | 0.1774 | N/A | CPU 准备持久拓扑和 snapshot 输入 |
| Merge 候选评分 | 0.4333 | 0.1870 | 0.2000 | 0.0050 | Shader 为诊断重新扫描已 split 的父节点；GPU 不提交这些候选 |
| Merge 拓扑提交 / 向上级联 | 0.0047 | 0.0210 | 0.0235 | N/A | 持久 merge、邻接修复和级联回收由 Classic/DOD CPU 路径执行；GPU shader 未提交 merge |
| Split 前 active leaf 收集 | 0.0000 | 0.0000 | 0.0000 | 0.0040 | DOD CPU 直接以持久 Q_s 表示 active leaf 与预算计数，本列为 0；GPU 在评分前仍单独压缩 snapshot |
| 视点相关 leaf error / 视锥测试 | 0.0000 | 0.0000 | 0.0000 | 0.0078 | Classic 与 DOD 都把评分计入持久 Q_s 优先级刷新，本列为 0；GPU 基于 snapshot 单独评分 |
| Split 扫描/标记 | 0.4486 | 0.3225 | 0.4926 | 0.0036 | DOD CPU 数值包含持久 Q_s 的并行 SSE/视锥优先级刷新、原地建堆和提交快照生成；GPU append 顺序不是误差优先级顺序 |
| Split 拓扑 / 裂缝约束提交 | 0.0093 | 0.0342 | 0.0426 | 0.0030 | GPU 只提交一轮受预算约束的细分，并只处理直接 base-neighbor diamond pair；没有递归 forced-split 链 |
...
| Mesh emit / draw argument 生成 | 0.0048 | 1.0635 | 0.0000 | 0.0098 | Classic 只重写拓扑变化影响的稳定槽位；DOD 仍完整 emit；GPU 输出非共享顶点、索引和 indirect draw argument |
| Finalize / 发布 packet | 0.5812 | 0.8032 | 0.8134 | N/A | CPU 发布统计和 renderer 资源契约 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 1.5990 | 0.1168 | 0.4333 | 0.0047 | 0.0000 | 0.0000 | 0.4486 | 0.0093 | 0.0000 | 0.0048 | 0.5812 | 0.0040 |
| Data-Oriented CPU ROAM | 2.6174 | 0.1857 | 0.1870 | 0.0210 | 0.0000 | 0.0000 | 0.3225 | 0.0342 | 0.0000 | 1.0635 | 0.8032 | 0.2092 |
| GPU ROAM-like | 1.7498 | 0.1774 | 0.2000 | 0.0235 | 0.0000 | 0.0000 | 0.4926 | 0.0426 | 0.0000 | 0.0000 | 0.8134 | 0.4375 |
...
| DoD Split | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0339 | 0.0339 | 0.0342 |
| Merge | 0.0016 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0175 | 0.0191 | 0.0210 |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 1 | 18.8048 | 10549.5106 | 10.2004 | 2121672 |
...
| --- | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 0.4579 | 0.4379 | 0.0048 | 0.0000 |
| Data-Oriented CPU ROAM | 0.3567 | 0.2080 | 1.0635 | 0.0000 |
| GPU ROAM-like | 0.5351 | 0.2236 | 0.0000 | 0.0000 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| GPU ROAM-like | 0.0040 | 0.0078 | 0.0036 | 0.0050 | 0.0030 | 0.0027 | 0.0038 | 0.0098 | 0.0398 | 0.0770 |
...
| GPU ROAM-like | 0.95 | 0.07 | 0.04 | 0.00 | 0.47 | 0.00 | 0.00 | 0.00 | 5524564 | 96 |
