...
- 详细 CSV：`runtime-benchmark-20260831-204849.csv`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 64 | 191.73 | 215.04 | 192.28 | 214.21 | 200000.00 | 200000 | 1125600.03 | 1614326 | 99.79 | 108.57 | 1 | 20 | 20 | 0 |
| Data-Oriented CPU ROAM | 64 | 102.57 | 135.39 | 102.85 | 134.78 | 199999.55 | 200000 | 1125597.62 | 1614322 | 178.20 | 421.38 | 8 | 20 | 20 | 0 |
| CBT 2024 | 64 | 0.88 | 33.53 | 0.04 | 0.08 | 296197.22 | 314328 | 296197.22 | 314328 | 0.00 | 0.00 | 0 | 20 | 20 | 0 |
...
- dropped/错代样本：0
- 最大诊断样本年龄：2 帧
- 平均 GPU 阶段合计：0.2379 ms
- 最大 GPU 阶段合计：0.2610 ms
...
| ReduceFirst | 0.0020 |
| ReduceSecond | 0.0014 |
| Indexation / indirect | 0.0179 |
| Render vertex evaluation | 0.0145 |
| Validation | 0.0018 |
| Terrain render | 0.1107 |
...
| --- | ---: | ---: | --- |
| Prepare / 帧状态 | 6.0789 | 6.4504 | 准备持久拓扑和逐帧输入 |
| Merge 候选评分 | 13.7621 | 2.3627 | 刷新持久 Q_m 的优先级 |
| Merge 拓扑提交 / 向上级联 | 16.8256 | 19.4987 | 提交 diamond merge、邻接修复和级联回收 |
| Split 前 active leaf 收集 | 0.0000 | 0.0000 | 两者均直接复用持久活动叶表示 |
| 视点相关 leaf error / 视锥测试 | 0.0000 | 0.0000 | 计入持久 Q_s 优先级刷新，因此独立字段为 0 |
| Split 扫描/标记 | 41.2399 | 5.4233 | 刷新 Q_s、建堆并生成提交候选 |
| Split 拓扑 / 裂缝约束提交 | 27.9582 | 26.6113 | 按同一预算与 forced-split 约束提交 |
| 细分后 active leaf 收集 / 输出视图 | 0.0000 | 0.0000 | Classic 复用 dense slot owners，DOD 复用 ActiveLeafNodes |
| Mesh emit / draw argument 生成 | 27.3929 | 9.7659 | 两者均只重写 dirty slot；DOD 可将较大批次分段给 worker |
| Finalize / 发布 packet | 54.5571 | 26.7215 | 汇总统计、更新跨帧状态并发布 renderer packet |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 187.8161 | 6.0789 | 13.7621 | 16.8256 | 0.0000 | 0.0000 | 41.2399 | 27.9582 | 0.0000 | 27.3929 | 54.5571 | 4.2723 |
| Data-Oriented CPU ROAM | 96.8341 | 6.4504 | 2.3627 | 19.4987 | 0.0000 | 0.0000 | 5.4233 | 26.6113 | 0.0000 | 9.7659 | 26.7215 | 5.7384 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic Split | 0 | 0 | 0 | 0 | 0 | 27.9582 | 27.9582 | 27.9582 |
| DoD Split | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 26.6108 | 26.6108 | 26.6113 |
| Merge | 0.1685 | 0.8443 | 0.2997 | 0.0060 | 3.4843 | 14.6845 | 19.4874 | 19.4987 |
...
| --- | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 69.1980 | 30.5877 | 27.3929 | 0.0000 |
| Data-Oriented CPU ROAM | 44.2666 | 21.8613 | 9.7659 | 0.0000 |
| CBT 2024 | 0.0530 | 0.0154 | 0.0146 | 0.0018 |

## 渲染与上传

| Algorithm | Frame fence wait | Render | Max render | Max upload B | Max readback B |
| --- | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 0.00 | 0.08 | 0.08 | 20126568 | 0 |
| Data-Oriented CPU ROAM | 0.00 | 0.09 | 0.09 | 20126064 | 0 |
| CBT 2024 | 0.97 | 0.25 | 0.28 | 0 | 428 |
