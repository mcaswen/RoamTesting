...
- 详细 CSV：`runtime-benchmark-20260828-200158.csv`
...
- Benchmark 标签：five-round-1280x720-extreme-r03
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 64 | 204.82 | 237.36 | 205.58 | 236.45 | 200000.00 | 200000 | 1127313.44 | 1618212 | 99.55 | 104.91 | 1 | 20 | 20 | 0 |
| Data-Oriented CPU ROAM | 64 | 114.57 | 153.52 | 115.20 | 153.01 | 199999.44 | 200000 | 1127303.84 | 1618198 | 173.08 | 406.94 | 8 | 20 | 20 | 0 |
| CBT 2024 | 64 | 0.43 | 0.70 | 0.05 | 0.13 | 201811.17 | 216723 | 201811.17 | 216723 | 0.00 | 0.00 | 0 | 20 | 20 | 0 |
...
- dropped/错代样本：0
- 最大诊断样本年龄：2 帧
- 平均 GPU 阶段合计：0.1740 ms
- 最大 GPU 阶段合计：0.3867 ms
...
| ReduceFirst | 0.0020 |
| ReduceSecond | 0.0014 |
| Indexation / indirect | 0.0163 |
| Render vertex evaluation | 0.0196 |
| Validation | 0.0015 |
| Terrain render | 0.0521 |
...
| --- | ---: | ---: | --- |
| Prepare / 帧状态 | 3.9590 | 4.4904 | 准备持久拓扑和逐帧输入 |
| Merge 候选评分 | 15.2517 | 2.8145 | 刷新持久 Q_m 的优先级 |
| Merge 拓扑提交 / 向上级联 | 19.3050 | 22.7496 | 提交 diamond merge、邻接修复和级联回收 |
| Split 前 active leaf 收集 | 0.0000 | 0.0000 | 两者均直接复用持久活动叶表示 |
| 视点相关 leaf error / 视锥测试 | 0.0000 | 0.0000 | 计入持久 Q_s 优先级刷新，因此独立字段为 0 |
| Split 扫描/标记 | 48.0236 | 6.5606 | 刷新 Q_s、建堆并生成提交候选 |
| Split 拓扑 / 裂缝约束提交 | 33.8384 | 32.3159 | 按同一预算与 forced-split 约束提交 |
| 细分后 active leaf 收集 / 输出视图 | 0.0000 | 0.0000 | Classic 复用 dense slot owners，DOD 复用 ActiveLeafNodes |
| Mesh emit / draw argument 生成 | 27.4016 | 11.6992 | 两者均只重写 dirty slot；DOD 可将较大批次分段给 worker |
| Finalize / 发布 packet | 52.3002 | 27.2159 | 汇总统计、更新跨帧状态并发布 renderer packet |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 200.0804 | 3.9590 | 15.2517 | 19.3050 | 0.0000 | 0.0000 | 48.0236 | 33.8384 | 0.0000 | 27.4016 | 52.3002 | 5.2595 |
| Data-Oriented CPU ROAM | 107.8463 | 4.4904 | 2.8145 | 22.7496 | 0.0000 | 0.0000 | 6.5606 | 32.3159 | 0.0000 | 11.6992 | 27.2159 | 7.0497 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic Split | 0 | 0 | 0 | 0 | 0 | 33.8384 | 33.8384 | 33.8384 |
| DoD Split | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 32.3157 | 32.3157 | 32.3159 |
| Merge | 0.1627 | 1.0515 | 0.4376 | 0.0098 | 4.3021 | 16.7722 | 22.7360 | 22.7496 |
...
| --- | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 81.8620 | 34.5567 | 27.4016 | 0.0000 |
| Data-Oriented CPU ROAM | 52.4808 | 25.5641 | 11.6992 | 0.0000 |
| CBT 2024 | 0.0494 | 0.0154 | 0.0199 | 0.0015 |

## 渲染与上传

| Algorithm | Frame fence wait | Render | Max render | Max upload B | Max readback B |
| --- | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 0.00 | 0.06 | 0.39 | 20251056 | 0 |
| Data-Oriented CPU ROAM | 0.00 | 0.06 | 0.06 | 20249208 | 0 |
| CBT 2024 | 0.22 | 0.19 | 0.40 | 0 | 428 |
