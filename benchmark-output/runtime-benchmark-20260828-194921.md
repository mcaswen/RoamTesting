...
- 详细 CSV：`runtime-benchmark-20260828-194921.csv`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 64 | 206.37 | 236.51 | 207.21 | 235.69 | 200000.00 | 200000 | 1127313.44 | 1618212 | 99.91 | 107.71 | 1 | 20 | 20 | 0 |
| Data-Oriented CPU ROAM | 64 | 127.65 | 170.67 | 127.60 | 169.96 | 199999.44 | 200000 | 1127303.84 | 1618198 | 171.02 | 373.51 | 8 | 20 | 20 | 0 |
| CBT 2024 | 64 | 2.89 | 31.36 | 0.05 | 0.13 | 201811.17 | 216723 | 201811.17 | 216723 | 0.00 | 0.00 | 0 | 20 | 20 | 0 |
...
- dropped/错代样本：0
- 最大诊断样本年龄：2 帧
- 平均 GPU 阶段合计：0.9762 ms
- 最大 GPU 阶段合计：2.9491 ms
...
| Split | 0.0284 |
| Allocate | 0.0437 |
| Neighbor copy | 0.0543 |
| Bisect | 0.0268 |
| PropagateBisect | 0.0278 |
| PrepareSimplify | 0.0167 |
| Simplify | 0.0236 |
| PropagateSimplify | 0.0281 |
| ReducePre | 0.0159 |
| ReduceFirst | 0.0122 |
| ReduceSecond | 0.0075 |
| Indexation / indirect | 0.0403 |
| Render vertex evaluation | 0.0412 |
| Validation | 0.0015 |
| Terrain render | 0.4289 |
...
| --- | ---: | ---: | --- |
| Prepare / 帧状态 | 6.9708 | 8.2994 | 准备持久拓扑和逐帧输入 |
| Merge 候选评分 | 14.3562 | 2.5108 | 刷新持久 Q_m 的优先级 |
| Merge 拓扑提交 / 向上级联 | 17.9064 | 23.2385 | 提交 diamond merge、邻接修复和级联回收 |
| Split 前 active leaf 收集 | 0.0000 | 0.0000 | 两者均直接复用持久活动叶表示 |
| 视点相关 leaf error / 视锥测试 | 0.0000 | 0.0000 | 计入持久 Q_s 优先级刷新，因此独立字段为 0 |
| Split 扫描/标记 | 43.5329 | 5.9320 | 刷新 Q_s、建堆并生成提交候选 |
| Split 拓扑 / 裂缝约束提交 | 29.4872 | 31.4771 | 按同一预算与 forced-split 约束提交 |
| 细分后 active leaf 收集 / 输出视图 | 0.0000 | 0.0000 | Classic 复用 dense slot owners，DOD 复用 ActiveLeafNodes |
| Mesh emit / draw argument 生成 | 28.6001 | 10.6906 | 两者均只重写 dirty slot；DOD 可将较大批次分段给 worker |
| Finalize / 发布 packet | 60.9408 | 38.8807 | 汇总统计、更新跨帧状态并发布 renderer packet |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 201.7960 | 6.9708 | 14.3562 | 17.9064 | 0.0000 | 0.0000 | 43.5329 | 29.4872 | 0.0000 | 28.6001 | 60.9408 | 5.2068 |
| Data-Oriented CPU ROAM | 121.0295 | 8.2994 | 2.5108 | 23.2385 | 0.0000 | 0.0000 | 5.9320 | 31.4771 | 0.0000 | 10.6906 | 38.8807 | 6.2660 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic Split | 0 | 0 | 0 | 0 | 0 | 29.4872 | 29.4872 | 29.4872 |
| DoD Split | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 31.4766 | 31.4766 | 31.4771 |
| Merge | 0.1861 | 0.9398 | 0.3176 | 0.0125 | 3.9702 | 17.7955 | 23.2217 | 23.2385 |
...
| --- | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 73.0201 | 32.2626 | 28.6001 | 0.0000 |
| Data-Oriented CPU ROAM | 52.2893 | 25.7493 | 10.6906 | 0.0000 |
| CBT 2024 | 0.1809 | 0.0683 | 0.0413 | 0.0015 |

## 渲染与上传

| Algorithm | Frame fence wait | Render | Max render | Max upload B | Max readback B |
| --- | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 0.00 | 0.80 | 2.26 | 20251056 | 0 |
| Data-Oriented CPU ROAM | 0.00 | 1.13 | 3.06 | 20249208 | 0 |
| CBT 2024 | 2.63 | 1.07 | 3.04 | 0 | 428 |
