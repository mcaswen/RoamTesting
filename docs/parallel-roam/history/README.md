...
本目录保存课程项目第一阶段和初始架构设计的历史快照。它们用于追溯早期范围、决策和三算法实验结论，不代表当前 D3D12 / CBT 2024 代码结构或开发阶段。

| 文档 | 历史范围 |
|---|---|
| [01-project-scope.md](01-project-scope.md) | OpenGL 三算法课程项目范围 |
| [02-theory-and-architecture.md](02-theory-and-architecture.md) | 初始理论、目录和接口提案 |
